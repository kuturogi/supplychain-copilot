...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "customer/supplychaincopilot/supplychaincopilotui/test/integration/StockLevelsListJourney.gen",
    "customer/supplychaincopilot/supplychaincopilotui/test/integration/StockLevelsObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
