sap.ui.define([], function () {
  ...
  const PALETTE = ["#0064d9", "#107e3e", "#e76500", "#6c3483", "#c0392b", "#1a7f8e", "#d4ac0d", "#784212", "#1e8bc3", "#27ae60"];
  function esc(s) {
  ...
  function buildPieChart(slices, title, size = 220) {
  ...
  function buildHorizontalBarChart(items, title, legend1 = "", legend2 = "") {
    ...
    const rows = items.map((item, idx) => {
      ...
      const barW2 = hasSeries2 && item.value2 !== undefined && maxVal > 0 ? item.value2 / maxVal * barAreaW : 0;
  ...
  function buildFunnelChart(steps, title) {
  ...
  function buildEmptyChart(title, size) {
    return `
        <div class="stChartCard">
            <div class="stChartTitle">${esc(title)}</div>
  ...
  __exports.buildPieChart = buildPieChart;
  __exports.buildHorizontalBarChart = buildHorizontalBarChart;
  __exports.buildFunnelChart = buildFunnelChart;
  return __exports;
});
//# sourceMappingURL=ChartBuilder-dbg.js.map
